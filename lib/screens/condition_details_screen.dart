...
class ConditionDetailsScreen extends StatelessWidget {
  ...
  static const Map<MentalCondition, String> _details = {
    ...
    MentalCondition.asd:
        'РАС — нейроразвитийная особенность, связанная с сенсорной чувствительностью и особенностями коммуникации. '
            'Помогают предсказуемость, визуальная структура задач и учет сенсорной нагрузки.',
  };
